...
/**
 * This entity is a spell that causes instantaneous death.
 * @author AbsentMoniker
 *
 */
public class AvadaKedavra extends Spell implements SpellDamage {

	public AvadaKedavra(GameplayState gameState, int id, int x, int y, int rotation) {
