...
/**
 * This entity is a spell whose effect is the equivalent of an invisible sword, slashing the target repeatedly.
 * @author AbsentMoniker
 *
 */
public class Sectumsempra extends Spell implements SpellDamage {
	public Sectumsempra(GameplayState gameState, int id, int x, int y, int rotation) {
